"""
Django settings for lucas_42627 project.
...
WSGI_APPLICATION = 'lucas_42627.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lucas_42627 API",
    "DESCRIPTION": "API documentation for lucas_42627 App",
    "VERSION": "v1",
}
